...
std::vector<std::pair<std::string::size_type, std::string>> EasyCrossPlatform::Basis::String::StringUtil::splitStringByNewLine(const std::string & StringToDealWith, int Limit)
{
	if (Limit == 0) {
...
std::vector<std::pair<std::string::size_type,std::string>> EasyCrossPlatform::Basis::String::StringUtil::splitStringByDivisor(const std::string & StringToDealWith, const std::string & Divisor, int Limit)
{
...
std::vector<std::pair<std::wstring::size_type, std::wstring>> EasyCrossPlatform::Basis::String::StringUtil::splitStringByNewLine(const std::wstring & StringToDealWith, int Limit)
{
	if (Limit == 0) {
...
std::vector<std::pair<std::wstring::size_type, std::wstring>> EasyCrossPlatform::Basis::String::StringUtil::splitStringByDivisor(const std::wstring & StringToDealWith, const std::wstring & Divisor, int Limit)
{
...
std::string EasyCrossPlatform::Basis::String::StringUtil::toLower(const std::string & StringToDealWith)
{
...
std::string EasyCrossPlatform::Basis::String::StringUtil::toUpper(const std::string & StringToDealWith)
{
	std::string myNewStr = StringToDealWith;
...
std::string EasyCrossPlatform::Basis::String::StringUtil::toSentence(const std::string & StringToDealWith)
{
	std::string myNewStr = StringToDealWith;
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::toLower(const std::wstring & StringToDealWith)
{
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::toUpper(const std::wstring & StringToDealWith)
{
	std::wstring myNewStr = StringToDealWith;
	std::transform(StringToDealWith.begin(), StringToDealWith.end(), myNewStr.begin(), ::toupper);
	return myNewStr;
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::toSentence(const std::wstring & StringToDealWith)
{
	std::wstring myNewStr = StringToDealWith;
	myNewStr = toLower(myNewStr);
	if (myNewStr.size() >= 1U) {
...
std::string EasyCrossPlatform::Basis::String::StringUtil::leftTrim(const std::string & StringToDealWith)
{
...
std::string EasyCrossPlatform::Basis::String::StringUtil::rightTrim(const std::string & StringToDealWith)
{
	std::string mString = StringToDealWith;
...
std::string EasyCrossPlatform::Basis::String::StringUtil::trim(const std::string & StringToDealWith)
{
	return leftTrim(rightTrim(StringToDealWith));
}

std::wstring EasyCrossPlatform::Basis::String::StringUtil::leftTrim(const std::wstring & StringToDealWith)
{
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::rightTrim(const std::wstring & StringToDealWith)
{
	std::wstring mString = StringToDealWith;
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::trim(const std::wstring & StringToDealWith)
{
	return leftTrim(rightTrim(StringToDealWith));
}

std::string EasyCrossPlatform::Basis::String::StringUtil::fromBytes(const std::vector<byte>& Bytes)
{
...
std::vector<byte> EasyCrossPlatform::Basis::String::StringUtil::toBytes(const std::string & myStr)
{
...
std::u16string EasyCrossPlatform::Basis::String::StringUtil::u16FromBytes(const std::vector<byte>& Bytes)
{
...
std::vector<byte> EasyCrossPlatform::Basis::String::StringUtil::toBytes(const std::u16string & myStr)
{
	std::vector<byte> mBytes = std::vector<byte>();
	const unsigned int SizeOfChar = sizeof(char16_t);
	byte mByteArray[SizeOfChar];
...
std::u32string EasyCrossPlatform::Basis::String::StringUtil::u32FromBytes(const std::vector<byte>& Bytes)
{
...
std::vector<byte> EasyCrossPlatform::Basis::String::StringUtil::toBytes(const std::u32string & myStr)
{
	std::vector<byte> mBytes = std::vector<byte>();
	const unsigned int SizeOfChar = sizeof(char32_t);
	byte mByteArray[SizeOfChar];
...
std::wstring EasyCrossPlatform::Basis::String::StringUtil::wFromBytes(const std::vector<byte>& Bytes)
{
...
std::vector<byte> EasyCrossPlatform::Basis::String::StringUtil::toBytes(const std::wstring & myStr)
{
	std::vector<byte> mBytes = std::vector<byte>();
	const unsigned int SizeOfWChar = sizeof(wchar_t);
...
unsigned int EasyCrossPlatform::Basis::String::StringUtil::replace(std::string & str, const std::string & find, const std::string & replace, int Limit, std::string::size_type Start)
{
...
unsigned int EasyCrossPlatform::Basis::String::StringUtil::replace(std::wstring & str, const std::wstring & find, const std::wstring & replace, int Limit, std::wstring::size_type Start)
{
	unsigned int NumReplaced = 0U;
