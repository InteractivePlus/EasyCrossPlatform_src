#ifndef __EASYCROSSPLATFORM_FILE_CROSSPLATFORM_OSDETECTION_INCLUDED__
	#define __EASYCROSSPLATFORM_FILE_CROSSPLATFORM_OSDETECTION_INCLUDED__
	//**********************************************OSDetection**********************************************
	...
	#define CROSSPLATFORM_OS_TYPE_WIN 0
	#define CROSSPLATFORM_OS_TYPE_UNIX 1
	#define CROSSPLATFORM_OS_TYPE_MAC 2
	
	#if defined(__WINDOWS_) || defined(_WIN32) || defined(__WIN32__) || defined(WIN32) || defined(_WIN64) || defined(__WIN64__) || defined(WIN64)
		#define CROSSPLATFORM_OS_TYPE CROSSPLATFORM_OS_TYPE_WIN
		...
		#define CROSSPLATFORM_OS_TYPE CROSSPLATFORM_OS_TYPE_UNIX
		#define EASYCROSSPLATFORM_PLATFORM_POSIX 1
		#ifndef CROSSPLATFORM_OS_STRING
			#define CROSSPLATFORM_OS_IS_UNIX 1
			#define CROSSPLATFORM_OS_STRING "linux"
		#endif
	#elif defined(__APPLE__) || defined(APPLE)
		#define CROSSPLATFORM_OS_TYPE CROSSPLATFORM_OS_TYPE_MAC
