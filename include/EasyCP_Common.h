	...
	//Remember that EASYCROSSPLATFORM_ARCHITECTURE_X86 / EASYCROSSPLATFORM_ARCHITECTURE_X64 / EASYCROSSPLATFORM_ARCHITECTURE_ARM64 will be defined in the compile process.
