			...
			namespace Socket {
				namespace TLS {
					...
					private:
						...
						StandardClientDisconnectCallBack m_DisconnectCallBack = NULL;
					protected:
						TLSSNIAsyncServerSingleConnection(TCP::TCPAsyncClientSocket* mClient, const std::vector<std::string>& SupportALPNProtos, unsigned int MinHandshakeTime = 1000U, unsigned int MaxHandshakeTime = 60000U);
						unsigned int MinHandshakeTime = 1000U;
						unsigned int MaxHandshakeTime = 60000U;
						std::vector<std::string> SupportedALPNProtocols;
					...
					protected:
						...
						void Init();
						void Destroy();
						TCP::TCPAsyncServerSocket* m_ServerSocket = NULL;
