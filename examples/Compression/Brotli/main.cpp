...
int main(int argc, char** args) {
	...
	*/
	...
	std::vector<byte> InfoAfterCompression = EasyCrossPlatform::Compression::Brotli::Encrypt(EasyCrossPlatform::Parser::StringUtil::toBytes(infoToCompress), CompressionLevel);
	std::cout << "Compressed:";
	...
	try {
		InfoAfterDecompresison = EasyCrossPlatform::Compression::Brotli::Decrypt(InfoAfterCompression);
	}
